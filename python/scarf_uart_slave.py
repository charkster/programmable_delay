...
class scarf_uart_slave:
	...
	# Constructor
#	def __init__(self, slave_id=0x00, num_addr_bytes=1, port=serial.Serial(port='/dev/ttyUSB2', baudrate=1000000, bytesize=8, parity='N', stopbits=1, timeout=0.01), debug=False):
	def __init__(self, slave_id=0x00, num_addr_bytes=1, port=pyftdi.serialext.serial_for_url('ftdi://ftdi:2232:1/2', baudrate=1000000, bytesize=8, parity='N', stopbits=1, timeout=0.01), debug=False):
